...
import DragnDropMapComponent from './dragndropMapComponent';
export default class ManageTagsComponent extends Component {
  constructor(props) {
    super(props);
...
class MainContent extends Component{
  ...
  render(){
    ...
    <div>
      ...
      <MapComponent app={app} name="tag"  cells={[{custom: DragnDropMapComponent, props:{app:app}}]}/>
    </div>
    )
  }
}
...
class BiggestCardColorTabWhite extends Component{
  ...
  render(){
    ...
    return(
      <div  style={{...styles?.biggestCard}}>   
      <div style={{...styles?.colorTabWhite , borderBottom:"1px solid black", height:"50px"}}> <TabContent app={app} /></div>   
      <div style={{...styles?.biggestCardContentWithTab}} className='scroller'>
        <MainContent app={app} />
        </div>
        </div>
