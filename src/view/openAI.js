...
class MainContent extends Component{
  ...
  async onSubmit(event) {
    ...
    try {
      debugger
     let response = await  generate(this.state.animalInput);
      ...
      <h3>Learn a word</h3>
        <form onSubmit={this.onSubmit}>
          <input
            ...
            value={this.state.animalInput}
            onChange={(e) => this.setState({animalInput: e.target.value})}
          />
          <input type="submit" value="Generate names" />
        </form>
        <div style={{fontSize:"20px"}}>{this.state.result}</div>
    </div>
    )
  }
}
...
class Card extends Component{
  ...
  render(){
    ...
    return(
      <div className='scroller'  style={{ ...styles[this.props.cardType?this.props.cardType:"biggestCard"] }}>   
...
class CardWithTab extends Component{
  ...
  render(){
    ...
    return(
      <div  style={{...styles[this.props.cardType?this.props.cardType:"biggestCard"] }}>   
